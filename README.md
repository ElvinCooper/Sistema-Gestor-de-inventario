...
Este proyecto es un Sistema de Gestión de Inventario y Pedidos basado en Python, conectado a una base de datos Oracle SQL. 
El sistema permite a los usuarios:
- Gestionar productos.
- Realizar un seguimiento de los niveles de inventario.
- Procesar pedidos de clientes de manera eficiente.
Está diseñado para pequeñas y medianas empresas que necesitan automatizar y optimizar sus procesos de gestión de inventario y pedidos.
